...
export default function BiodiversitySection({
  ...
  absObligations = ['Obtain prior approval from National Biodiversity Authority (NBA) via Form I for commercial utilization', 'Mandatory disclosure of biological resource geographical origin in patent filings (Section 6)', 'Ensure Prior Informed Consent (PIC) and fair and equitable benefit-sharing compliance'],
  ...
  classicalReferences = ['Charaka Samhita — Chikitsa Sthana (Rasayana Vidhi)', 'Ayurvedic Pharmacopoeia of India (API) Monograph Index', 'Traditional Knowledge Digital Library (TKDL) Prior-Art Database'],
  evidence = {
      ...
      <div className="flex items-center justify-between border-b border-[#161412]/10 pb-3">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xs font-mono font-bold uppercase tracking-[0.2em] text-emerald-800">{t("biodiversitysection.bIODIVERSITYTRADITIONALKNOWLEDGE", "BIODIVERSITY & TRADITIONAL KNOWLEDGE")}</h3>
          </div>
