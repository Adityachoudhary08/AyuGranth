      ...
      <div className="flex items-center justify-between border-b border-[#161412]/10 pb-3">
        <div>
          ...
          <p className="text-xs text-[#161412]/60 mt-0.5">
            Audit history, version updates, and intelligence refreshes
          </p>
        </div>
          ...
          <div key={idx} className="relative pl-6">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                ...
                {item.status && (
                  <span className="px-2 py-0.2 rounded text-[9.5px] font-mono font-bold uppercase bg-amber-50 text-amber-900 border border-amber-200">
                    {item.status}
                  </span>
                )}
              </div>
