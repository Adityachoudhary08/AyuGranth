...
export default function PassportVerification({
  ...
  return (
    <section className={cn("bg-[#FAF8F3] border-2 border-[#D9CEBE] rounded-2xl p-6 sm:p-8 shadow-xs", className)}>
        ...
        <div className="space-y-3 text-left w-full md:w-auto">
          ...
          <div className="pt-2 flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-[#161412]/20 hover:border-[#176B45]/50 text-xs font-semibold text-[#161412] rounded-lg transition-all shadow-2xs cursor-pointer"
            >
