  ...
  return (
    <section id="section-international" className={cn("bg-white border border-[#161412]/15 rounded-2xl p-6 sm:p-8 shadow-xs space-y-6", className)}>
      ...
      <div className="flex items-center justify-between border-b border-[#161412]/10 pb-3">
        <div>
          ...
          <p className="text-xs text-[#161412]/60 mt-0.5">
            Cross-border regulatory alignment, export quality thresholds, and destination compliance
          </p>
        </div>
      ...
      <div className="bg-[#FAF8F3] border border-[#161412]/15 rounded-xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <span className="text-[10px] font-mono uppercase tracking-wider text-[#8C6D46] font-bold block mb-1">
            TRADE CORRIDOR
          </span>
        ...
        <div className="sm:text-right">
          <span className="text-[10px] font-mono uppercase tracking-wider text-[#161412]/50 block mb-1">
            Destination Status
          </span>
      ...
      <div>
        <h4 className="text-[11px] font-mono font-bold uppercase tracking-wider text-[#161412]/80 mb-3">
          Destination Market Requirements ({targetCountry})
        </h4>
      ...
      {missingInfo && missingInfo.length > 0 && (
        <div className="p-4 rounded-xl border border-amber-200 bg-amber-50/60 text-xs">
          <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-amber-900 block mb-1.5">
            Dossier Gaps / Missing Documentation for Clearance:
          </span>
