    ...
    <section id="section-ip" className={cn("bg-white border border-[#161412]/15 rounded-2xl p-6 sm:p-8 shadow-xs space-y-6", className)}>
      ...
      <div className="flex items-center justify-between border-b border-[#161412]/10 pb-3">
        <div>
          ...
          <p className="text-xs text-[#161412]/60 mt-0.5">
            Indian patent law signals, Section 3(p)/3(d) criteria, prior-art relevance, and trademark bounds
          </p>
        </div>
      ...
      <div>
        <h4 className="text-[11px] font-mono font-bold uppercase tracking-wider text-[#161412]/80 mb-3">
          Identified Patentability &amp; Regulatory Risks
        </h4>
      ...
      <div className="p-4 rounded-xl bg-[#FAF8F3] border border-[#161412]/10 text-xs">
        <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-[#8C6D46] block mb-1">
          Trademark &amp; Class 5 Branding Bounds
        </span>
      ...
      <div>
        <h4 className="text-[11px] font-mono font-bold uppercase tracking-wider text-[#8C6D46] mb-2.5">
          Legal Basis &amp; Prior-Art Evidence
        </h4>
        <EvidenceBlock
