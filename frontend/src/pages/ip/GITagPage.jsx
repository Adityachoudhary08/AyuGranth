      ...
      <main className="max-w-4xl mx-auto pt-28 px-4 sm:px-6 flex flex-col items-center">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#176B45]/10 text-[#176B45] text-xs font-bold uppercase tracking-widest rounded-full mb-4">
            <MapPin className="w-3.5 h-3.5" />{t("gitagpage.originAssessment", "Origin Assessment")}</div>
          <h1 className="text-4xl md:text-5xl font-serif text-[#161412] mb-4">{t("gitagpage.gINavigator", "GI Navigator")}</h1>
          <p className="text-[#161412]/60 max-w-xl mx-auto">{t("gitagpage.checkifyourproduct", "Check if your product has a documented regional-origin association and evaluate eligibility under the Geographical Indications Act.")}</p>
        </div>
        ...
        <div className="w-full max-w-3xl flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            {error && <div className="w-full p-4 mb-4 bg-red-50 border border-red-200 text-red-700 rounded-xl flex items-start gap-3">
            ...
            {result && !isLoading && (
              <div className="flex-1 bg-white rounded-2xl border border-[#161412]/15 shadow-sm overflow-hidden animate-in fade-in slide-in-from-right-4 duration-500">
                <div className={cn("p-4 border-b flex items-start gap-3", getStatusColor(result.color))}>
                  ...
                  <div>
                    <div className="font-bold uppercase tracking-wider text-[10px] opacity-70 mb-0.5">{t("gitagpage.eligibilityStatus", "Eligibility Status")}</div>
