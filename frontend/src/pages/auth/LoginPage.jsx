          ...
          <div className="hidden lg:block space-y-6">
            ...
            <div className="block">
              <div className="inline-flex items-center gap-2 rounded-full bg-[#176B45]/10 px-3 py-1 text-[10px] font-mono font-bold uppercase tracking-[0.2em] text-[#176B45]">
                ...
                IP-SAKTI Sahayak & AyuGranth Portal
              </div>
            </div>

            <h1 className="font-serif text-4xl xl:text-5xl leading-[1.15] text-[#161412]">
              Evidence-grounded intelligence for Ayurvedic Intellectual Property.
            </h1>

            <p className="text-sm leading-relaxed text-[#161412]/70 max-w-lg">
              Sign in to generate verifiable Product Passports, cross-reference formulations against the Traditional Knowledge Digital Library (TKDL), and screen statutory ABS obligations under the National Biodiversity Act.
            </p>
            ...
            <div className="pt-4 space-y-4 max-w-md border-t border-[#161412]/10">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-[#161412] uppercase tracking-wide">TKDL Prior-Art Screening</h4>
                  <p className="text-xs text-[#161412]/60 mt-0.5">Cross-check against classical formulations and shloka citations.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-[#161412] uppercase tracking-wide">ABS & Statutory Compliance</h4>
                  <p className="text-xs text-[#161412]/60 mt-0.5">Determine State Biodiversity Board and NBA regulatory pathways.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-[#161412] uppercase tracking-wide">QR Product Passports</h4>
                  <p className="text-xs text-[#161412]/60 mt-0.5">Export verifiable digital passports for market and regulatory audit.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-3xl border border-[#161412]/10 bg-white p-7 sm:p-9 shadow-[0_12px_40px_rgba(22,20,18,0.06)]">
              ...
              <div className="mb-6">
                ...
                <p className="text-xs text-[#161412]/60 mt-1.5">
                  Enter your institutional or practitioner credentials.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="vaidya@ayugranth.org"
                ...
                <div className="flex items-center justify-between pt-1">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#176B45] hover:text-[#125537] hover:underline cursor-pointer"
                  >
