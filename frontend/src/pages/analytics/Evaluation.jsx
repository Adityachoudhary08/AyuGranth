  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-[#161412]/60">Live performance metrics of the AyuGranth core AI models and retrieval systems.</p>
      </div>

      {isLoading && (
        <div className="py-20 flex flex-col items-center justify-center">
          <div className="w-8 h-8 rounded-full border-2 border-[#176B45] border-t-transparent animate-spin mb-4" />
          <p className="text-[#161412]/60 font-medium">Loading benchmarking data...</p>
        </div>
      )}
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white border border-[#161412]/10 rounded-xl p-6 shadow-sm">
              <div className="flex items-center gap-3 text-[#161412]/60 mb-3">
                ...
                <h3 className="font-medium">Total Benchmark Queries</h3>
              </div>
            ...
            <div className="bg-white border border-[#161412]/10 rounded-xl p-6 shadow-sm">
              <div className="flex items-center gap-3 text-[#161412]/60 mb-3">
                ...
                <h3 className="font-medium">Average Relevance Score</h3>
              </div>
            ...
            <div className="bg-white border border-[#161412]/10 rounded-xl p-6 shadow-sm">
              <div className="flex items-center gap-3 text-[#161412]/60 mb-3">
                ...
                <h3 className="font-medium">Average Faithfulness</h3>
              </div>
            ...
            <div className="bg-white border border-[#161412]/10 rounded-xl p-6 shadow-sm">
              <div className="flex items-center gap-3 text-[#161412]/60 mb-3">
                ...
                <h3 className="font-medium">Average Latency</h3>
              </div>
          ...
          <div className="bg-white border border-[#161412]/10 rounded-xl shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-[#161412]/10 bg-[#f8f7f4]">
              <h3 className="font-serif text-lg text-[#161412]">Detailed Query Evaluations</h3>
            </div>
              ...
              <table className="w-full text-left text-sm text-[#161412]/80">
                <thead className="bg-gray-50 border-b border-[#161412]/10 text-xs uppercase tracking-wider text-[#161412]/50">
                  <tr>
                    ...
                    <th className="px-6 py-4 font-medium w-32">Relevance</th>
                    <th className="px-6 py-4 font-medium w-32">Faithfulness</th>
                    <th className="px-6 py-4 font-medium w-32">Latency</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#161412]/10">
                  {metrics.evaluations.map((evalItem, idx) => (
                    <tr key={idx} className="hover:bg-[#161412]/5 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex-1 h-1.5 bg-[#161412]/10 rounded-full">
                            <div className="h-full bg-blue-500 rounded-full" style={{ width: `${evalItem.relevance_score * 100}%` }} />
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex-1 h-1.5 bg-[#161412]/10 rounded-full">
                            <div className="h-full bg-purple-500 rounded-full" style={{ width: `${evalItem.faithfulness_score * 100}%` }} />
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 text-[#161412]/60">
                        {Math.round(evalItem.latency_ms)} ms
                      </td>
                    </tr>
                  ))}
                </tbody>
