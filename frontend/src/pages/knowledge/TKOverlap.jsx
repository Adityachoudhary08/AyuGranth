  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-[#161412]/60">Check ingredients against the TKDL (Traditional Knowledge Digital Library) parameters.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 space-y-6">
          <form onSubmit={handleSubmit} className="bg-white border border-[#161412]/10 rounded-xl p-5 shadow-sm space-y-4">
            <div>
              <label className="block text-sm font-medium text-[#161412] mb-1">Ingredients <span className="text-red-500">*</span></label>
              <textarea
                value={ingredients}
        ...
        <div className="lg:col-span-2 space-y-6">
          {!result && !isLoading && (
             <div className="h-full flex flex-col items-center justify-center text-center p-12 border border-[#161412]/10 border-dashed rounded-xl opacity-50 bg-white">
               ...
               <p className="text-[#161412] font-medium">Enter ingredients</p>
               <p className="text-sm text-[#161412]/60 mt-1 max-w-sm">We'll search for classical formulations and TKDL mappings.</p>
             </div>
          )}
          ...
          {isLoading && (
             <div className="h-full flex flex-col items-center justify-center text-center p-12 border border-[#161412]/10 rounded-xl bg-white shadow-sm">
               ...
               <p className="text-[#161412] font-medium">Scanning TKDL references...</p>
             </div>
          )}
              ...
              {result.classical_references && result.classical_references.length > 0 && (
                <div className="bg-white border border-[#161412]/10 rounded-xl overflow-hidden shadow-sm">
                  <div className="px-5 py-3 border-b border-[#161412]/10 bg-[#f8f7f4]">
                    <h3 className="font-serif text-lg text-[#161412]">Classical Text References</h3>
                  </div>
                  <div className="divide-y divide-[#161412]/10">
                    {result.classical_references.map((ref, idx) => (
                      <div key={idx} className="p-5 flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#161412]/60">Chapter: {ref.chapter}, Verse: {ref.verse}</p>
